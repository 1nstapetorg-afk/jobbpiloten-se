 ...
 * is the ground-truth evidence artifact (tiers computed from 100+
 * real application forms across Teamtailor / getwiser / in-page / …);
 * this module is the curated, UX-ready projection of that schema plus
 * domain knowledge where the corpus is thin (industries with few live
 * forms). The two must stay in sync when the corpus grows — re-run the
 * scraper's build-taxonomy.js and reconcile Tier 2 additions here.
 *
