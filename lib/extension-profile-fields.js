...
export const ROUND12_BOOLEAN_LABELS = {
  hasDriversLicense: 'B-körkort',
  isEuCitizen: 'EU/EEA-medborgare',
  hasWorkPermit: 'Arbetstillstånd',
  hasHighSchoolDiploma: 'Gymnasieexamen',
  hasForkliftLicense: 'Truckförarbevis',
  hasSecurityClearance: 'Säkerhetsklassad',
  hasLeadershipExperience: 'Ledarerfarenhet',
  isBilingual: 'Tvärspråkig (SV + EN)',
  hasTechnicalEducation: 'Teknisk utbildning',
  hasCustomerExperience: 'Kundservice-erfarenhet',
}
