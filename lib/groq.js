...
// (Groq retired llama-3.2-90b-vision-preview on 2025-04-14; the app's
// primary TEXT model llama-3.3-70b-versatile is scheduled for shutdown
// 2026-08-16 per Groq's deprecation schedule). A single hardcoded
// `provider.model` means one decommissioned model takes down ALL
// cover-letter / email / answer generation until a code deploy lands.
//
...
//   • groq secondary = qwen/qwen3.6-27b — the same multimodal model
//     lib/cv-ocr.js uses (live-verified with this key on 2026-08-02),
//     and a strong text model in its own right.
 ...
 * (e.g. llama-3.3-70b-versatile). lib/cv-ocr.js maps it to a
 * vision-capable model per provider (e.g. qwen/qwen3.6-27b for Groq —
 * the old llama-3.2-90b-vision-preview was decommissioned 2025-04-14);
 * `name` is the discriminator it switches on.
 */
